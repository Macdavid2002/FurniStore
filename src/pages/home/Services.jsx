    ...
    <div className="mt-48 text-center">
      ...
      <div className="grid grid-cols-1 gap-12 p-4 mt-5 md:grid-cols-3 ">
        <div className="flex flex-col items-center md:justify-center border border-gray-400 rounded-md  p-4 ">
          ...
          <p className="text-md md:w-[100%] w-[300px] px-4 text-center text-gray-500">
        ...
        <div className="flex flex-col items-center md:justify-center border border-gray-400 rounded-md  p-4 ">
          ...
          <p className="text-md w-[100%] text-center px-2 text-gray-500">
        ...
        <div className="flex flex-col items-center md:justify-center border border-gray-400 rounded-md  p-4 ">
          ...
          <p className="text-md w-[100%] text-center text-gray-500">
