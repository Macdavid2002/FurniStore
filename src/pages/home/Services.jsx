...
export const Services = () => {
  return (
    <div className="mt-48 text-center">
      ...
      <div className="grid grid-cols-1 gap-12 p-4 mt-5 lg:grid-cols-3 ">
        <div className="flex flex-col items-center md:justify-center shadow-md rounded-md  p-4 ">
          <HomeIcon className="w-14 md:w-20 text-gray-500  p-4 cursor-pointer" />
          <h1 className=" text-2xl md:text-xl text-gray-500 py-4 mr-8">
            Interior Design
          </h1>
          <p className="text-sm md:w-[100%] text-center w-[300px] px-4  text-gray-500">
        ...
        <div className="flex flex-col items-center md:justify-center shadow-md rounded-md  p-4 ">
          ...
          <p className="text-sm w-[100%] text-center px-6 text-gray-500">
            At Meubles we offer installment and arrangement for our clients
            based on their preference.
          </p>
        </div>
        <div className="flex flex-col items-center md:justify-center shadow-md rounded-md  p-4 ">
          <HomeModernIcon className="md:w-20 w-14 text-gray-500  p-4 cursor-pointer" />
          <h1 className=" text-2xl md:text-xl text-gray-500 py-4 mr-8">
            Outdoor Design
          </h1>
          <p className="text-sm w-[100%] text-center text-gray-500">
