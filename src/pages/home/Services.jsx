  ...
  return (
    <div className="mt-48 text-center">
      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 gap-4 p-4 mt-5 lg:flex">
        <div className="flex flex-col items-center md:justify-center  shadow-md bg-[#F8F7F4] rounded-md  p-4 ">
          <HomeIcon className="w-14 md:w-20 text-black  p-4 cursor-pointer" />
          <h1 className=" text-2xl md:text-xl text-black py-4 mr-8">
            Interior Design
          </h1>
          <p className="text-sm md:w-[100%] text-center w-[300px] px-4  text-black">
        ...
        <div className="flex flex-col items-center md:justify-center  shadow-md bg-[#F8F7F4] rounded-md  p-4 ">
          ...
          <p className="text-sm w-[100%] text-center px-6 text-black">
        ...
        <div className="flex flex-col items-center md:justify-center  shadow-md bg-[#F8F7F4] rounded-md  p-4 ">
          ...
          <p className="text-sm w-[100%] text-center text-black">
