...
//       <div className="container mx-auto flex items-center justify-between sm:flex ">
...
//           <input
//             className="border border-white rounded-md outline-none p-1 w-full placeholder:p-2 "
...
//             Rooms
//           </Link>
//           <Link className="text-white hover:text-black text-lg font-medium focus:text-black">
//             About
//           </Link>
//           <Link
//             to="/"
