...
import { ProductLayout } from "../../../ui/product-layout/product-navigation/ProductLayout";
export const Products = () => {
  ...
  return (
    <div className="mt-8 font-cinzel">
      ...
      <h1 className="px-8 pt-12 py-4 text-3xl font-semibold ">Products</h1>
      ...
      <span className="flex justify-center items-center gap-2 my-10 ">
        ...
        <button className=" px-2 py-1 bg-gray-300 rounded-md">1</button>
        <Link to="/products/2">
